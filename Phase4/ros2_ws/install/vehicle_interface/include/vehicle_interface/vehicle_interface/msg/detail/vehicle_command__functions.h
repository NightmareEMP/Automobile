...
#ifndef VEHICLE_INTERFACE__MSG__DETAIL__VEHICLE_COMMAND__FUNCTIONS_H_
#define VEHICLE_INTERFACE__MSG__DETAIL__VEHICLE_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * vehicle_interface__msg__VehicleCommand__init().
...
/**
 * It calls
 * vehicle_interface__msg__VehicleCommand__fini()
 ...
 * vehicle_interface__msg__VehicleCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vehicle_interface__msg__VehicleCommand__Sequence__fini()
 * on the array,
...
#endif  // VEHICLE_INTERFACE__MSG__DETAIL__VEHICLE_COMMAND__FUNCTIONS_H_
