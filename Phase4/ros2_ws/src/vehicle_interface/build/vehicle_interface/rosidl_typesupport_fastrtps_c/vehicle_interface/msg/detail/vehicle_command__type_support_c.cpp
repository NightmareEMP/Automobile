...
#include "vehicle_interface/msg/detail/vehicle_command__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleCommand__ros_msg_type = vehicle_interface__msg__VehicleCommand;
...
size_t get_serialized_size_vehicle_interface__msg__VehicleCommand(
  const void * untyped_ros_message,
...
static uint32_t _VehicleCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_interface__msg__VehicleCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_interface
size_t max_serialized_size_vehicle_interface__msg__VehicleCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_interface__msg__VehicleCommand;
    is_plain =
      (
...
static size_t _VehicleCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehicle_interface__msg__VehicleCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_interface, msg, VehicleCommand)() {
