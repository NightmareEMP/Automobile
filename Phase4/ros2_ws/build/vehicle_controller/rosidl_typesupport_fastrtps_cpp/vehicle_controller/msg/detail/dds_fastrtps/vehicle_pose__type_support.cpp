...
#include "vehicle_controller/msg/detail/vehicle_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_controller::msg::VehiclePose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_controller::msg::VehiclePose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_controller::msg::VehiclePose *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehiclePose__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vehicle_controller::msg::VehiclePose *>(
...
static size_t _VehiclePose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VehiclePose(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VehiclePose__callbacks = {
...
static rosidl_message_type_support_t _VehiclePose__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehiclePose__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_vehicle_controller
const rosidl_message_type_support_t *
get_message_type_support_handle<vehicle_controller::msg::VehiclePose>()
{
  return &vehicle_controller::msg::typesupport_fastrtps_cpp::_VehiclePose__handle;
}
