...
#include "vehicle_interface/msg/detail/vehicle_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_interface::msg::VehicleCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_interface::msg::VehicleCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_interface::msg::VehicleCommand *>(
    untyped_ros_message);
...
{
  return &vehicle_interface::msg::typesupport_fastrtps_cpp::_VehicleCommand__handle;
}
